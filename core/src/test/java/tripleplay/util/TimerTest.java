...
public class TimerTest {
    ...
    public static Platform plat = new StubPlatform();
    ...
    @Test public void testCancelBefore () {
        Timer timer = new Timer(0);
        Counter r1 = new Counter();
    ...
    @Test public void testDoubleCancel () {
    ...
    @Test public void testInternalCancel () {
        final InternalCanceler ran1 = new InternalCanceler();
        Timer t = new Timer(0);
        ran1.handle = t.every(2, ran1);
        for (int ii = 0; ii < 7; ii++) t.update(plat, ii + 1);
        assertEquals(1, ran1.ranCount);
    }
