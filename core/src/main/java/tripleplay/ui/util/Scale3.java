 ...
 * normally a multiple of 3). By using {@link #xaxis}, this partitioning can be controlled
 * directly. For example, if the horizontal middle of an image is a single pixel, this code will do
