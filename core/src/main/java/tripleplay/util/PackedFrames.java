...
public class PackedFrames implements Frames
{
    ...
    @Override public int count () { return _frames.length; }
    @Override public Rectangle bounds (int index) { return _frames[index].bounds; }
    @Override public Point offset (int index) { return _frames[index].offset; }
